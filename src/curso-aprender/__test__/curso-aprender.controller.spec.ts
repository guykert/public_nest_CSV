...
describe('CursoAprenderController', () => {
  let controller: CursoAprenderController;
  let service: CursoAprenderService;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreateCursoAprenderDto) =>
          Promise.resolve({ id: '1', ...createDto }),
        ),
      update: jest
        .fn()
        .mockImplementation((id: 'a uuid', updateDto: UpdateCursoAprenderDto) =>
  ...
  beforeEach(async () => {
    ...
    controller = module.get<CursoAprenderController>(CursoAprenderController);
    service = module.get<CursoAprenderService>(CursoAprenderService);
  }); 
  ...
  describe('update/:id', () => {
    ...
    it('should update a new Asignaturas Curriculares', async () => {
      const updateDto: UpdateCursoAprenderDto = DATAMOCK.One;
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreateCursoAprenderDto = DATAMOCK.One;
