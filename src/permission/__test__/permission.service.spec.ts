...
describe('InglesService', () => {
  ...
  describe('updateOne', () => {
    it('should call the update method', async () => {
      ...
      expect(PermissionModel.findOneAndUpdate).toBeCalledTimes(1);
      expect(PermissionModel.findOneAndUpdate).toBeCalledWith(
        { _id: 'a uuid' },
  ...
  describe('deleteOne', () => {
    ...
    it('should return {deleted: false, message: err.message}', async () => {
      const repoSpy = jest
        .spyOn(PermissionModel, 'findByIdAndDelete')
