...
describe('PruebaEjeTematicoController', () => {
  let controller: PruebaEjeTematicoController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreatePruebaEjeTematicoDto) =>
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: PruebaEjeTematicoService,
    ...
    controller = module.get<PruebaEjeTematicoController>(PruebaEjeTematicoController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreatePruebaEjeTematicoDto = DATAMOCK.One;
