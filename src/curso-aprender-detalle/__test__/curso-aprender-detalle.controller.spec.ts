...
describe('CursoAprenderController', () => {
  let controller: CursoAprenderDetalleController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreateCursoAprenderDetalleDto) =>
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: CursoAprenderDetalleService,
    ...
    controller = module.get<CursoAprenderDetalleController>(CursoAprenderDetalleController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreateCursoAprenderDetalleDto = DATAMOCK.One;
