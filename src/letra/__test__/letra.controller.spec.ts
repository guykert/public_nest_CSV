...
describe('LetraController', () => {
  let controller: LetraController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreateLetraDto) =>
  ...
  beforeEach(async () => {
    ...
    controller = module.get<LetraController>(LetraController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreateLetraDto = DATAMOCK.One;
