...
describe('PruebaTablaConversionDetalleController', () => {
  let controller: PruebaTablaConversionDetalleController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreatePruebaTablaConversionDetalleDto) =>
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: PruebaTablaConversionDetalleService,
    ...
    controller = module.get<PruebaTablaConversionDetalleController>(PruebaTablaConversionDetalleController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreatePruebaTablaConversionDetalleDto = DATAMOCK.One;
