...
describe('PruebaTablaComversionController', () => {
  let controller: PruebaTablaComversionController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreatePruebaTablaComversionDto) =>
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: PruebaTablaComversionService,
    ...
    controller = module.get<PruebaTablaComversionController>(PruebaTablaComversionController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreatePruebaTablaComversionDto = DATAMOCK.One;
