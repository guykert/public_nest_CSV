...
describe('PruebaPautaController', () => {
  let controller: PruebaPautaController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreatePruebaPautaDto) =>
  ...
  beforeEach(async () => {
    ...
    controller = module.get<PruebaPautaController>(PruebaPautaController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreatePruebaPautaDto = DATAMOCK.One;
