...
describe('TipoAlumnoController', () => {
  let controller: TipoAlumnoController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreateTipoAlumnoDto) =>
  ...
  beforeEach(async () => {
    ...
    controller = module.get<TipoAlumnoController>(TipoAlumnoController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreateTipoAlumnoDto = DATAMOCK.One;
