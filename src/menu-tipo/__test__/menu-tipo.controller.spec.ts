...
describe('MenuTipoController', () => {
  let controller: MenuTipoController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreateMenuTipoDto) =>
  ...
  beforeEach(async () => {
    ...
    controller = module.get<MenuTipoController>(MenuTipoController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreateMenuTipoDto = DATAMOCK.One;
