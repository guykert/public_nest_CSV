...
describe('PruebaTipoController', () => {
  let controller: PruebaTipoController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreatePruebaTipoDto) =>
  ...
  beforeEach(async () => {
    ...
    controller = module.get<PruebaTipoController>(PruebaTipoController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreatePruebaTipoDto = DATAMOCK.One;
