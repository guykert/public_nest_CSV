...
describe('CursoAprenderService', () => {
  ...
  describe('insertOne', () => {
    it('should successfully insert a cat', () => {
      ...
      expect(EmpresaModel.create).toBeCalledTimes(1);
      expect(EmpresaModel.create).toBeCalledWith({
        ...DATAMOCK.One,
  ...
  describe('updateOne', () => {
    it('should call the update method', async () => {
      ...
      expect(EmpresaModel.findOneAndUpdate).toBeCalledTimes(1);
      expect(EmpresaModel.findOneAndUpdate).toBeCalledWith(
        { _id: 'a uuid' },
  ...
  describe('deleteOne', () => {
    ...
    it('should return {deleted: false, message: err.message}', async () => {
      const repoSpy = jest
        .spyOn(EmpresaModel, 'findByIdAndDelete')
