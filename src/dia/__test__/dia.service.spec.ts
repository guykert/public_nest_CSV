...
describe('CursoAprenderService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: getModelToken(Dia.name),
          useValue: mockModel
        },
    ...
    DiaModel = module.get<Model<Dia>>(getModelToken(Dia.name));
  ...
  describe('insertOne', () => {
    it('should successfully insert a cat', () => {
      ...
      expect(DiaModel.create).toBeCalledTimes(1);
      expect(DiaModel.create).toBeCalledWith({
        ...DATAMOCK.One,
  ...
  describe('updateOne', () => {
    it('should call the update method', async () => {
      ...
      expect(DiaModel.findOneAndUpdate).toBeCalledTimes(1);
      expect(DiaModel.findOneAndUpdate).toBeCalledWith(
        { _id: 'a uuid' },
  ...
  describe('deleteOne', () => {
    ...
    it('should return {deleted: false, message: err.message}', async () => {
      const repoSpy = jest
        .spyOn(DiaModel, 'findByIdAndDelete')
