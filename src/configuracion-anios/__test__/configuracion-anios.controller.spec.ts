...
describe('ConfiguracionAniosController', () => {
  let controller: ConfiguracionAniosController;
  ...
  const mockService = {
      ...
      create: jest
        .fn()
        .mockImplementation((createDto: CreateConfiguracionAnioDto) =>
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: ConfiguracionAniosService,
    ...
    controller = module.get<ConfiguracionAniosController>(ConfiguracionAniosController);
  ...
  describe('create/', () => {
    ...
    it('should create a new Asignaturas Curriculares', async () => {
      const CreateDto: CreateConfiguracionAnioDto = DATAMOCK.One;
